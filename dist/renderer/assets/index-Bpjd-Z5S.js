...
function Sidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "sidebar-search", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "input", placeholder: "搜索壁纸...", value: localSearch, onChange: (e) => setLocalSearch(e.target.value) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "button", disabled: loading, children: "🔍" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "分区" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "category-buttons", children: categoriesList.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "排行榜时间范围" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toprange-buttons", children: topRangeOptions.map((opt) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "类别" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: categories.general, onChange: () => setCategories({ ...categories, general: !categories.general }) }),
          " 常规"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: categories.anime, onChange: () => setCategories({ ...categories, anime: !categories.anime }) }),
          " 动漫"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: categories.people, onChange: () => setCategories({ ...categories, people: !categories.people }) }),
          " 真人"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "图片等级" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filter-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: purityFlags.sfw, onChange: (e) => setPurityFlags({ ...purityFlags, sfw: e.target.checked }) }),
          " 正常 (SFW)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: purityFlags.sketchy, onChange: (e) => setPurityFlags({ ...purityFlags, sketchy: e.target.checked }) }),
          " 擦边 (Sketchy)"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: purityFlags.nsfw, onChange: (e) => setPurityFlags({ ...purityFlags, nsfw: e.target.checked }) }),
          " 限制级 (NSFW)"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "分辨率" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", className: "input", placeholder: "例如 1920x1080", onChange: (e) => onFilterChange && onFilterChange("resolution", e.target.value) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-title", children: "比例" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "input", onChange: (e) => onFilterChange && onFilterChange("ratio", e.target.value), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "不限" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "16x9", children: "16:9" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "16x10", children: "16:10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "4x3", children: "4:3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "21x9", children: "21:9" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button refresh-btn", onClick: onRefresh, disabled: loading, children: "🔄 刷新" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button settings-btn", onClick: onOpenSettings, children: "⚙️ 软件设置" })
  ] });
}
function ImageGrid({ images, selectedIds, onToggleSelect, onSelectAll, onLoadMore, hasMore, loading, downloadTasks }) {
  const getTaskStatus = (id) => downloadTasks.find((t) => t.id === id)?.status;
  const getProgress = (id) => downloadTasks.find((t) => t.id === id)?.progress;
  if (images.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "40px", color: "#aaa" }, children: "输入关键词开始搜索壁纸" });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "找到 ",
        images.length,
        " 张壁纸"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button button-secondary", onClick: onSelectAll, children: selectedIds.size === images.length ? "取消全选" : "全选当前页" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "image-grid", children: images.map((img) => {
      const status = getTaskStatus(img.id);
      const progress = getProgress(img.id);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `image-card ${selectedIds.has(img.id) ? "selected" : ""}`, onClick: () => onToggleSelect(img.id), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "checkbox-wrapper", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: selectedIds.has(img.id), onChange: () => onToggleSelect(img.id), onClick: (e) => e.stopPropagation() }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img.thumb, alt: img.id, loading: "lazy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "image-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "image-id", children: img.id }),
          status && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `download-status ${status}`, children: [
            status === "downloading" && `${Math.round(progress || 0)}%`,
            status === "completed" && "✓ 完成",
            status === "failed" && "✗ 失败",
            status === "skipped" && "⏭ 跳过"
          ] })
        ] }),
        status === "downloading" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-fill", style: { width: `${progress || 0}%` } }) })
      ] }, img.id);
    }) }),
    hasMore && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "load-more", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button", onClick: onLoadMore, disabled: loading, children: loading ? "加载中..." : "加载更多" }) })
  ] });
}
function DownloadPanel({ selectedCount, totalCount, onSelectAll, onDownload, downloading, downloadTasks }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "download-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px", borderBottom: "1px solid #3d3d3d" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { marginBottom: "12px" }, children: "下载面板" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button", onClick: onDownload, disabled: downloading || selectedCount === 0, style: { width: "100%", marginBottom: "8px" }, children: downloading ? "下载中..." : `批量下载 (${selectedCount})` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "button button-secondary", onClick: onSelectAll, style: { width: "100%" }, children: "全选当前页" })
    ] }),
    (downloading || downloadTasks.length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { style: { marginBottom: "12px" }, children: "下载进度" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "12px", fontSize: "13px", display: "flex", gap: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "✅ 完成: ",
          completed
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-fill", style: { width: `${downloadTasks.length ? (completed + skipped) / downloadTasks.length * 100 : 0}%` } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxHeight: "400px", overflowY: "auto" }, children: downloadTasks.slice().reverse().map((task) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "task-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontFamily: "monospace" }, children: task.id }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `download-status ${task.status}`, children: [
            task.status === "downloading" && `${Math.round(task.progress || 0)}%`,
            task.status === "completed" && "完成",
            task.status === "failed" && "失败",
            task.status === "skipped" && "已存在"
          ] })
        ] }),
        task.status === "downloading" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-fill", style: { width: `${task.progress || 0}%` } }) }),
        task.error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "10px", color: "#f44336" }, children: task.error })
      ] }, task.id)) })
    ] })
  ] });
}
function SettingsPanel({ apiKey, setApiKey, concurrency, setConcurrency, downloadDir, onSelectDir, onClearCache, onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "软件设置" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "password", value: apiKey, onChange: (e) => setApiKey(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "并发线程 (8-16)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", min: "8", max: "16", value: concurrency, onChange: (e) => setConcurrency(Number(e.target.value)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "下载目录" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { readOnly: true, value: downloadDir || "未选择" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onSelectDir, children: "浏览" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "setting-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClearCache, className: "danger-btn", children: "清空下载缓存" }) })
    ] })
  ] });
}
...
function App() {
  ...
  const [downloadDir, setDownloadDir] = reactExports.useState(null);
  const [concurrency, setConcurrency] = reactExports.useState(16);
  const [apiKey, setApiKey] = reactExports.useState("");
  const [purityFlags, setPurityFlags] = reactExports.useState({ sfw: true, sketchy: false, nsfw: false });
  const [downloading, setDownloading] = reactExports.useState(false);
  const [downloadTasks, setDownloadTasks] = reactExports.useState([]);
  const [activeCategory, setActiveCategory] = reactExports.useState("all");
  const [topRange, setTopRange] = reactExports.useState("1M");
  const [categories, setCategories] = reactExports.useState({ general: true, anime: true, people: true });
  const [showSettings, setShowSettings] = reactExports.useState(false);
  const [extraFilters, setExtraFilters] = reactExports.useState({ resolution: "", ratio: "" });
  ...
  reactExports.useEffect(() => {
    if (apiKey !== void 0 && concurrency && downloadDir) {
  ...
  const searchImages = reactExports.useCallback(async (query, page = 1, sortBy = "relevance", order = "desc", range = null) => {
    setLoading(true);
    try {
  ...
  const selectAll = () => {
    if (selectedIds.size === images.length) setSelectedIds(/* @__PURE__ */ new Set());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-layout", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-area", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ImageGrid,
        {
          images,
          selectedIds,
